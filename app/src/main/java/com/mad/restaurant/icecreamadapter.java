...
public class icecreamadapter extends BaseAdapter {

    private Context context;
    private int layout;
    private ArrayList<promo_model> icelist;

    public icecreamadapter(Context context, int layout, ArrayList<promo_model> icelist) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        }promo_model promo_model=icelist.get(i);
