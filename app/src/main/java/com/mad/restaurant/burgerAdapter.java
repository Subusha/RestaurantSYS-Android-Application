...
public class burgerAdapter extends BaseAdapter {
    ...
    private int layout;
    private ArrayList<promo_model> burgerlist;

    public burgerAdapter(Context context, int layout, ArrayList<promo_model> burgerlist) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        promo_model promo_model=burgerlist.get(i);
